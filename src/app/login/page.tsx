...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[var(--background)] p-4 relative overflow-hidden">
            ...
            <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[var(--primary)]/5 rounded-full blur-[100px] -z-10" />
            <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[var(--color-info)]/20 rounded-full blur-[100px] -z-10" />
            ...
            <div className="w-full max-w-md bg-[var(--card)] border border-[var(--border)] rounded-[var(--radius-m)] p-8 shadow-2xl relative z-10 backdrop-blur-sm">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-[600] text-[var(--foreground)] font-primary mb-2">Welcome Back</h1>
                    <p className="text-[var(--muted-foreground)] font-secondary">Sign in to the DoYou admin dashboard</p>
                </div>
